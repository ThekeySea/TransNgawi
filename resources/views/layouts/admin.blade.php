    ...
    <div class="admin-layout">
        ...
        <aside class="admin-sidebar">
            ...
            <nav class="flex-1 py-4" aria-label="Navigasi admin">
                ...
                <a href="{{ route('admin.refunds.index') }}" class="mx-3 flex items-center gap-3 rounded-[var(--radius-sm)] px-3 py-2.5 text-sm font-semibold transition-colors @if(request()->routeIs('admin.refunds.*')) bg-[#ff750f]/10 text-[#ff750f] @else text-[#1a1a1a] hover:bg-[#ff750f]/10 hover:text-[#ff750f] @endif">
                    <svg class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 10h10a8 8 0 018 8v2M3 10l6 6m-6-6l6-6"/></svg>
                    Refund
                </a>
